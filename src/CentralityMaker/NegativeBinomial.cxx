/******************************************************************************
 * $Id: NegativeBinomial.cxx,v 1.2 2012/04/25 05:13:24 hmasui Exp $
 * $Log: NegativeBinomial.cxx,v $
...
UInt_t NegativeBinomial::mCounter = 0 ;

//____________________________________________________________________________________________________
NegativeBinomial::NegativeBinomial(const Double_t npp, const Double_t k, const Double_t x,
...
//____________________________________________________________________________________________________
void NegativeBinomial::InitHistogram()
{
...
//____________________________________________________________________________________________________
void NegativeBinomial::SetParameters(const Double_t npp, const Double_t k, const Double_t x)
{
  mNpp = npp ;
  mK   = k ;
...
//____________________________________________________________________________________________________
Double_t NegativeBinomial::GetTwoComponentMultiplicity(const Double_t npart, const Double_t ncoll) const
{
...
//____________________________________________________________________________________________________
Int_t NegativeBinomial::GetMultiplicity(const Double_t npart, const Double_t ncoll) const
{
  ...
  for(Int_t im=0; im<2*multIdeal; im++){
    if( GlauberUtilities::instance()->GetUniform2() <= efficiency ){
      mult++;
    }
  }
  ...
  for(Int_t im=0; im<nmult; im++){
    if( GlauberUtilities::instance()->GetUniform() <= mTriggerBias ){
      mult++;
    }
  }
...
//____________________________________________________________________________________________________
TH1* NegativeBinomial::GetMultiplicity(const Double_t npart, const Double_t ncoll,
...
//____________________________________________________________________________________________________
Double_t NegativeBinomial::GetNegativeBinomial(const Int_t n) const
{
...
//____________________________________________________________________________________________________
Double_t NegativeBinomial::GetNegativeBinomial(const Int_t n, const Double_t m) const
{
...
Double_t NegativeBinomial::GetEfficiency(const Int_t mult) const
{
  /// Check flag
  if( mIsConstEfficiency ){
    Error("NegativeBinomial::GetEfficiency", "Something is wrong, supposed to be constant efficiency. abort");
    assert(0) ;
  }
...
void NegativeBinomial::DrawNbd() const
{
  if(mhNbd) mhNbd->Draw() ;
}
