...
class CentralityMaker {
  public:
    CentralityMaker(); /// Default constructor
    CentralityMaker(const Char_t* system); /// Call init(const Char_t* system)
  ...
  private:
    ...
    // Data members
    std::vector<NegativeBinomial*> mNBinomial ; /// Negative binomial utility
    std::vector<Centrality*> mCentrality      ; /// Centrality utility
