...
#ifndef __NbdFitMaker_h__
#define __NbdFitMaker_h__
...
class NbdFitMaker {
  public:
    NbdFitMaker();
    virtual ~NbdFitMaker(); /// Default destructor
    ...
    /// [1] = NDF
    /// [2] = chi2/NDF
    TGraph* Fit(const Int_t nevents = 1000, const Char_t* outputFileName = "");
...
//        const Int_t effbin, const Double_t effmin, const Double_t effmax,
  ...
  private:
    ...
    // Data members
    NegativeBinomial* mNBinomial ; /// Negative binomial distribution
