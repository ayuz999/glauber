...
#ifndef __NegativeBinomial_h__
#define __NegativeBinomial_h__
...
class NegativeBinomial {
  public:
    ...
    NegativeBinomial(const Double_t npp = 2.38, const Double_t k = 2.00, const Double_t x = 0.13,
...
inline Double_t NegativeBinomial::GetNpp() const { return mNpp ; }
inline Double_t NegativeBinomial::GetK()  const { return mK ; }
inline Double_t NegativeBinomial::GetX()  const { return mX ; }
inline Double_t NegativeBinomial::GetEfficiency() const { return mEfficiency ; }
inline Bool_t   NegativeBinomial::IsConstEfficiency() const { return mIsConstEfficiency ; }
