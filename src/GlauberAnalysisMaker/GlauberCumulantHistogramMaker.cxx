...
GlauberCumulantHistogramMaker::GlauberCumulantHistogramMaker(const TString name, const TString title, const TString ytitle,
    const Int_t ybin, const Double_t ymin, const Double_t ymax, const Bool_t isUnitWeight)
  : GlauberHistogramMaker(name, title, ytitle, ybin, ymin, ymax, isUnitWeight)
{
  Init() ;
}
...
// Default destructor
GlauberCumulantHistogramMaker::~GlauberCumulantHistogramMaker()
{
  Reset() ;
}

//____________________________________________________________________________________________________
void GlauberCumulantHistogramMaker::Init()
{
...
//____________________________________________________________________________________________________
void GlauberCumulantHistogramMaker::Reset()
{
  GlauberHistogramMaker::Reset() ;
...
//____________________________________________________________________________________________________
void GlauberCumulantHistogramMaker::Fill(const Double_t y, const Double_t weight)
{
  /// Fill 'y' value with 'weight'
  GlauberHistogramMaker::Fill(y, weight);
...
//____________________________________________________________________________________________________
void GlauberCumulantHistogramMaker::Finish(const TString type)
{
  /// Call StGlauberHistogramMaker::Finish() first
  GlauberHistogramMaker::Finish(type) ;
...
//____________________________________________________________________________________________________
UInt_t GlauberCumulantHistogramMaker::GetOrder(const UInt_t io) const
{
  return (io+1)*2 ;
}

//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::Get4thOrderCumulant(const Double_t c2, const Double_t c4) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::Get6thOrderCumulant(const Double_t c2, const Double_t c4, const Double_t c6) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::GetNthOrderCumulantError(const Double_t order, const Double_t val, const Double_t err) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::Get2ndOrderCumulantError(const Double_t c2, const Double_t c2error) const
{
  return GetNthOrderCumulantError(0.5, c2, c2error) ;
}

//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::Get4thOrderCumulantError(const Double_t c2, const Double_t c4,
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::Get6thOrderCumulantError(const Double_t c2, const Double_t c4, const Double_t c6,
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::GetCumulant(const UInt_t order, const Double_t* val) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberCumulantHistogramMaker::GetCumulantError(const UInt_t order, const Double_t* val, const Double_t* err) const
{
