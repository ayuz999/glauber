...
#ifndef __GlauberPlotMaker_h__
#define __GlauberPlotMaker_h__
...
class GlauberPlotMaker {
  public:
    GlauberPlotMaker(const TString name="Npart"); /// Default constructor
    virtual ~GlauberPlotMaker(); /// Default destructor
