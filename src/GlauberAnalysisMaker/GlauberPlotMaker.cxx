...
UInt_t GlauberPlotMaker::mCanvasId = 0 ;
UInt_t GlauberPlotMaker::mGraphId  = 0 ;

//____________________________________________________________________________________________________
// Default constructor
GlauberPlotMaker::GlauberPlotMaker(const TString name)
  : mName(name)
{
  mGraph.clear() ;
  mGraphDraw.clear() ;
...
//____________________________________________________________________________________________________
// Default destructor
GlauberPlotMaker::~GlauberPlotMaker()
{
  mGraph.clear() ;
  mGraphDraw.clear() ;
...
//____________________________________________________________________________________________________
Int_t GlauberPlotMaker::Read(const TString filename, const TString type)
{
  ifstream fin(filename.Data());
  if(!fin){
    Error("GlauberPlotMaker::Read", "can't open %s", filename.Data());
    return 0 ;
  }
  ...
  Double_t val, error ;
  for(UInt_t ic=0; ic<GlauberConstUtilities::GetCentralityBin(); ic++){
...
//____________________________________________________________________________________________________
Double_t GlauberPlotMaker::GetYMinimum() const
{
  Double_t ymin = 0.0 ;
...
//____________________________________________________________________________________________________
Double_t GlauberPlotMaker::GetYMaximum() const
{
  Double_t ymax = 0.0 ;
...
//____________________________________________________________________________________________________
TString GlauberPlotMaker::GetYTitle() const
{
  TString title("");
...
//____________________________________________________________________________________________________
TGraphErrors* GlauberPlotMaker::Divide(const TGraphErrors& g0, const TGraphErrors& g1) const
{
...
//____________________________________________________________________________________________________
TGraphErrors* GlauberPlotMaker::SystematicErrors(const UInt_t mode)
{
...
//____________________________________________________________________________________________________
void GlauberPlotMaker::Draw(const UInt_t mode)
{
...
//  c1->Print(Form("%s_systematic_error.png", mName.Data()));
  ...
  for(Int_t ic=0; ic<mGraph[0]->GetN(); ic++){
    ...
    const Double_t centMin = GlauberConstUtilities::GetCentralityMin(ic) ;
    const Double_t centMax = GlauberConstUtilities::GetCentralityMax(ic) ;
