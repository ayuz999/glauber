...
#ifndef __GlauberHistogramMaker_h__
#define __GlauberHistogramMaker_h__
...
class GlauberHistogramMaker {
  public:
    GlauberHistogramMaker() ; /// Default constructor

    // Fixed bin width
    GlauberHistogramMaker(const TString name, 
    ...
    ~GlauberHistogramMaker() ; /// Default destructor
    ...
    void SetXaxis(const GlauberTree& tree, const CentralityMaker& centralityMaker, const TString type); /// Set X-axis variable
...
inline UInt_t GlauberHistogramMaker::GetNXaxis() const { return mNXaxis ; }
