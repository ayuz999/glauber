...
#ifndef __GlauberCumulantHistogramMaker_h__
#define __GlauberCumulantHistogramMaker_h__
...
class GlauberCumulantHistogramMaker : public GlauberHistogramMaker {
  public:
    // Fixed bin width, make histograms up to 6th order cumulant
    GlauberCumulantHistogramMaker(const TString name, 
    ...
    ~GlauberCumulantHistogramMaker() ; /// Default destructor
