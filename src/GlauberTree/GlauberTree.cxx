...
GlauberTree::GlauberTree(const UInt_t mode) : mMode(mode) {
...
//____________________________________________________________________________________________________
Int_t GlauberTree::Open(const TString filename)
{
  if(mMode==0){
    // Read mode
    mFile = TFile::Open(filename);
    if(!mFile || !mFile->IsOpen()){
      Error("GlauberTree::Open", "can't open %s", filename.Data());
      assert(0);
    }
    // Get tree
    mTree = (TTree*) mFile->Get("tree");
    if(!mTree){
      Error("GlauberTree::Open", "No tree found in %s", filename.Data());
      assert(0);
    }

    mHeader = (TTree*) mFile->Get("header");
    if(!mHeader){
      Error("GlauberTree::Open", "No header found in %s", filename.Data());
      assert(0);
    }
...
//____________________________________________________________________________________________________
Int_t GlauberTree::Fill()
{
  return mTree->Fill();
}

//____________________________________________________________________________________________________
Int_t GlauberTree::FillHeader()
{
  return mHeader->Fill();
}

//____________________________________________________________________________________________________
Int_t GlauberTree::Close()
{
...
//____________________________________________________________________________________________________
Int_t GlauberTree::GetEntries() const
{
  return mTree->GetEntries() ;
}

//____________________________________________________________________________________________________
Int_t GlauberTree::GetEntry(const Int_t ievent)
{
  return mTree->GetEntry(ievent);
}

//____________________________________________________________________________________________________
Double_t GlauberTree::GetSigmaA2(const Double_t a2, const Double_t a) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberTree::GetSigmaXY(const Double_t xy, const Double_t x, const Double_t y) const
{
  return xy - x*y ;
}

//____________________________________________________________________________________________________
Double_t GlauberTree::GetSRP(const UInt_t id) const
{
...
//____________________________________________________________________________________________________
Double_t GlauberTree::GetSPP(const UInt_t id) const
{
...
//____________________________________________________________________________________________________
void GlauberTree::SetNameNucleusA(const Char_t* val)
{
  sprintf(mNameNucleusA, "%s", val);
}

//____________________________________________________________________________________________________
void GlauberTree::SetNameNucleusB(const Char_t* val)
{
